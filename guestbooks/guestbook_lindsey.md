...
#### Sean
- **What is done well:** Your code is fantastic to read. It's simple, clean, and maximizes the functionality of IPYNB's outputs. You rarely flash things, and you kept things moving in a straight line. In addition to your code, I like that your project had a similar feel. You had two simple yet important goals, and you solved them! I really enjoyed this project because of the thorough treatment you gave your own analysis, as well as the questions you answered.
- **Possible improvements: ** Like I said, I'm a huge fan of the amount of introspection and analysis you did, but I disagree with some small aspects of it. For example, it seems like the last category (the oldest speakers) were a very small segment, with only a few samples. I think it was great to move towards four generational groups, but even then the last group didn't have a ton of samples. Obviously you can't help this, but I'd just keep it in mind during analysis.
- **What I learned:** I think this project is the pinnicle of functionality. It was a real treat to see the way you took advantage of everything IPYNB had to offer, not to mention the python libraries. The style here was impeccable, and I hope to emulate it in the future.