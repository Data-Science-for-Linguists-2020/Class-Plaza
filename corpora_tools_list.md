...
| --------- | :-----------: | ------- |
| [The British National Corpus](http://www.natcorp.ox.ac.uk/) | online or purchase | 100 million wordcollection of samples of written and spoken language from multiple sources, designed to represent a wide cross-section of British English from the late 20th century |
...
| [Yelp Review Data](https://www.yelp.com/dataset/challenge) | free, open source | A corpora of over six million reviews of around 90,000 businesses in ten metropolitan areas. There's even a challenge for students based on this data.
| [CDC Assorted Corpora](https://data.cdc.gov/browse) | free, open source | A series of open corpora spanning a variety of topics in recent (within the decade) health trends.
| [Wikipedia Articles](https://en.wikipedia.org/wiki/Wikipedia:Database_download#English-language_Wikipedia) | free, open source | A very large corpora (58GB uncompressed, 14GB compressed) containing English language Wikipedia articles.
...
| [TreeTagger](https://www.cis.uni-muenchen.de/~schmid/tools/TreeTagger/) | free download | A tool for annotating text with part-of-speech and lemma information. It has been used to tag text in German, English, French, Italian, Danish, Swedish, Norwegian, Dutch, Spanish, Bulgarian, Russian, Portuguese, Galician, Greek, Chinese, Swahili, Slovak, Slovenian, Latin, Estonian, Polish, Romanian, Czech, Coptic and old French texts. It can be adapted for other languages as well if the user has access to a lexicon and a manually tagged training corpus. TreeTagger is freely available for research, education and evaluation. |
| [ELAN](https://tla.mpi.nl/tools/tla-tools/elan/) | free download | A mutimedia annotation tool in which a user can add an unlimited number of annotations to either video or audio. Works with Windows, Mac OS X, and Linux and supports a large variety of video and audio formats.
| [Word2vec (gensim) ](https://radimrehurek.com/gensim/models/word2vec.html) | free, open source | Information and documentation about using Word2vec and other gensim models for deep learning |
| [StanfordCoreNLP](https://nlp.stanford.edu/software/) | free, open source | A suite of resources in a variety of languages (written in Java, but portable) developed by Stanford's NLP group--taggers, parsers, and more. |